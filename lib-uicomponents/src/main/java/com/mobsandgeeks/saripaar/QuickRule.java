 ...
 * {@link QuickRule}s can exist without Annotations. These rules are
 * directly applied to {@link View}s. They are added to the
 * {@link com.mobsandgeeks.saripaar.Validator} using the
 * {@link com.mobsandgeeks.saripaar.Validator#put(View, QuickRule[])} method.
 *
 * @param <VIEW>  The {@link View} on which this rule is to be applied.
 *
...
public abstract class QuickRule<VIEW extends View> extends Rule<VIEW> {
     ...
     *
     * @param view  The {@link View} on which the rule has to be applied.
     *
