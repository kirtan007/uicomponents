 ...
 * {@link ViewDataAdapter}s that are registered to rule
 * {@link Annotation}s.
 *
...
final class Registry {
    ...
    /**
     * Registers {@link ViewDataAdapter}s for the associated
     ...
     * @param viewDataAdapter  The {@link ViewDataAdapter}
     ...
     *      is returned by the {@link ViewDataAdapter}.
     */
    ...
    /**
     * Retrieves the registered {@link ViewDataAdapter} associated
     ...
     *      the {@link ViewDataAdapter}.
     *
     * @return Registered or compatible
     *      {@link ViewDataAdapter} or null if none is
     *      found.
     */
    @SuppressWarnings("unchecked")
