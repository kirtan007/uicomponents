...
public class HtmlTextView extends JellyBeanSpanFixTextView
{
    ...
    {
        void onLayoutChanged(HtmlTextView htmlTextView);

    }

    private ILayoutListener layoutListener;
    public void setOnLayoutListener(ILayoutListener listener)
    {
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom)
    {
        ...
        {
            layoutListener.onLayoutChanged(this);
        }
    }
    ...
    public void setHtmlFromString(String html, ImageGetter imageGetter)
    {
        ...
        //   Spanned spanned =Html.fromHtml(html, htmlImageGetter, new HtmlTagHandler());
        setText(trimTrailingWhitespace(Html.fromHtml(html, htmlImageGetter, new HtmlTagHandler())));
